                ...
                foreach ($this->cart->contents() as $rows) {
                    ...
                    <tr>
                        ...
                        <td data-title="Product Image &amp; name" class="t_md_align_c">
                            <img width="50" src="<?php echo base_url() . $rows['image'] ?>" alt="" class="m_md_bottom_5 d_xs_block d_xs_centered">
                            <a href="#" class="d_inline_b m_left_5 color_dark"><?php echo $rows['name'] ?></a>
                        </td>
                        <!--product key-->
                        <td data-title="SKU"><?php echo $rows['sku'] ?></td>
                        <!--product price-->
                        <td data-title="Price">

                            <p class="f_size_large color_dark"><?php echo $rows['price'] ?> TK. </p>
                        </td>
                        <!--quanity-->
                        <td data-title="Quantity">
                            <!--                        <div class="clearfix quantity r_corners d_inline_middle f_size_medium color_dark m_bottom_10">
                                                        <button class="bg_tr d_block f_left" data-direction="down">-</button>
                                                        <input type="text" name="" readonly value="<?php // echo $rows['qty']   ?>" class="f_left">
                                                        <button class="bg_tr d_block f_left" data-direction="up">+</button>
                                                    </div>-->
                            <div>
                                <form action="<?php echo base_url(); ?>Cart/update_cart/<?php echo $rows['rowid'] ?>" method="post">
                                    <input type="number" name="quantity" value="<?php echo $rows['qty'] ?>">
                                    <br>
                                    <br>
                                ...
                                <a href="<?php echo base_url() ?>Cart/delete_cart/<?php echo $rows['rowid'] ?>" class="color_dark"><i class="fa fa-times f_size_medium m_right_5"></i>Remove</a><br>
                            </div>
                        </td>
                        <!--subtotal-->
                        <td data-title="Subtotal">
                            <p class="f_size_large fw_medium scheme_color"><?php echo $rows['subtotal'] ?> TK.</p>
                        </td>
                    </tr>
...
<!--                                                    <input type="text" placeholder="Enter your coupon code" name="" class="r_corners f_size_medium">
                ...
                <tr>
                    <td colspan="4" class="  t_xs_align_l">
                        ...
                        &nbsp;
                        <a href="<?php echo base_url(); ?>Checkout"><button class="button_type_6 bg_scheme_color f_size_large r_corners tr_all_hover color_light m_bottom_20">Checkout</button></a>
                    </td>
